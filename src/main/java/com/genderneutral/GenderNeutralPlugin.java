...
public class GenderNeutralPlugin extends Plugin
{
	...
	{
		log.info("Gender Neutral started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Gender Neutral stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Gender Neutral says " + config.greeting(), null);
		}
	}
